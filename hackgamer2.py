...
class Player(pygame.sprite.Sprite):
    ...
    def draw_player_shape(self):
        ...
        body_rect = pygame.Rect(0, self.height * 0.2, self.width, self.height * 0.8)
        pygame.draw.rect(self.image, BLUE_PLAYER, body_rect, border_top_left_radius=10, border_top_right_radius=10,
                         border_bottom_left_radius=5, border_bottom_right_radius=5)
        head_rect = pygame.Rect(self.width * 0.1, 0, self.width * 0.8, self.height * 0.3)
        pygame.draw.ellipse(self.image, (150, 180, 240), head_rect)
        pygame.draw.ellipse(self.image, DARK_GREY, head_rect, 2)
        eye_rect = pygame.Rect(self.width * 0.3, self.height * 0.05, self.width * 0.4, self.height * 0.15)
        pygame.draw.ellipse(self.image, (200, 255, 255), eye_rect)
            ...
            if self.rect.bottom >= self.base_y:
                ...
                for _ in range(5):
                    particles.append(Particle(
                        self.rect.centerx + random.uniform(-self.width / 2, self.width / 2), self.rect.bottom,
                        (180, 180, 180), random.uniform(1, 3),
                        random.uniform(-30, 30), random.uniform(-30, -10), 200, 0.3
                    ))
            else:
                ...
                if self.jetpack_timer <= 0:
                    particles.append(Particle(
                        ...
                        random.choice([(255, 100, 0), (255, 150, 50), YELLOW]), random.uniform(2, 5),
                        0, random.uniform(30, 60), -50, 0.3
                    ))
    ...
    def jump(self):
        if not self.is_jumping:
            ...
            self.jetpack_timer = 0.1
            for _ in range(8):
                particles.append(Particle(
                    self.rect.centerx, self.rect.bottom,
                    random.choice([(255, 180, 80), (255, 220, 100)]), random.uniform(2, 4),
                    random.uniform(-20, 20), random.uniform(40, 80), -100, 0.4
                ))
